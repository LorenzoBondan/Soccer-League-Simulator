package br.com.projects.webapi.api.v1.rest.championship;
...
public class ChampionshipController {
     ...
     */
    @Operation(summary = "Search all Championships by columns, operations, and values", method = "GET")
    @ApiResponses(value = {
     ...
     */
    @Operation(summary = "Search a Championship by id", method = "GET", description = "Search an object by id, regardless of its status")
    @ApiResponses(value = {
    ...
    /**
     * @param dto represents the Championship object to be created
     */
    @Operation(summary = "Insert a new Championship", method = "POST")
    @ApiResponses(value = {
    ...
    public ResponseEntity<?> create(
            @RequestBody
            @Schema(
                    description = "Championship object for creation",
                    requiredProperties = "league.id, season.id",
                    example = """
                    {
                        "league": {
                            "id": 1
    ...
    /**
     * @param dto represents the Championship object to be updated
     */
    @Operation(summary = "Update a Championship", method = "PUT")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Ok"),
            @ApiResponse(responseCode = "400", description = "Bad Request"),
            @ApiResponse(responseCode = "401", description = "Unauthorized"),
    ...
    public ResponseEntity<?> update(
            @RequestBody
            @Schema(
                    description = "Championship object for editing",
                    requiredProperties = "id, league.id, season.id",
                    example = """
                    {
                        "id": 1,
                        "league": {
    ...
    /**
     * @param codes list of Championship codes to be deleted
     */
    @Operation(summary = "Delete a list of Championships", method = "DELETE", description = "The status of the objects is changed to 'Trash'")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Ok"),
