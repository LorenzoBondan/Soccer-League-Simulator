package br.com.projects.webapi.api.v1.rest.championshipteam;
...
@Tag(name = "ChampionshipTeam")
@RestController
@RequestMapping("/api/championshipteam")
public class ChampionshipTeamController {

    private final ChampionshipTeamService service;

    public ChampionshipTeamController(ChampionshipTeamService service) {
     ...
     */
    @Operation(summary = "Search all ChampionshipTeams by columns, operations, and values", method = "GET")
    @ApiResponses(value = {
    ...
    /**
     * @param id represents the ID of the ChampionshipTeam to be searched
     */
    @Operation(summary = "Search a ChampionshipTeam by id", method = "GET", description = "Search an object by id, regardless of its status")
    @ApiResponses(value = {
    ...
    /**
     * @param dto represents the ChampionshipTeam object to be created
     */
    @Operation(summary = "Insert a new ChampionshipTeam", method = "POST")
    @ApiResponses(value = {
    ...
    public ResponseEntity<?> create(
            @RequestBody
            @Schema(
                    description = "ChampionshipTeam object for creation",
                    requiredProperties = "championship.id, team.id",
                    example = """
                    {
                        "championship": {
                            "id": 1
            ...
            DChampionshipTeam dto) {
        return ResponseEntity.status(HttpStatus.CREATED).body(service.insert(dto));
    }

    /**
     * @param dto represents the ChampionshipTeam object to be updated
     */
    @Operation(summary = "Update a ChampionshipTeam", method = "PUT")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Ok"),
            @ApiResponse(responseCode = "400", description = "Bad Request"),
            @ApiResponse(responseCode = "401", description = "Unauthorized"),
    ...
    public ResponseEntity<?> update(
            @RequestBody
            @Schema(
                    description = "ChampionshipTeam object for editing",
                    requiredProperties = "id, championship.id, team.id",
                    example = """
                    {
                        "id": 1,
                        "championship": {
    ...
    /**
     * @param codes list of ChampionshipTeam codes to be deleted
     */
    @Operation(summary = "Delete a list of ChampionshipTeams", method = "DELETE", description = "The status of the objects is changed to 'Trash'")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Ok"),
