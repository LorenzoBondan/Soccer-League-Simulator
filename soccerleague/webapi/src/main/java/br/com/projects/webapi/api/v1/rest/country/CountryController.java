package br.com.projects.webapi.api.v1.rest.country;
...
public class CountryController {
     ...
     */
    @Operation(summary = "Search all Countries by columns, operations, and values", method = "GET")
    @ApiResponses(value = {
    ...
    /**
     * @param id represents the ID of the Country to be searched
     */
    @Operation(summary = "Search a Country by id", method = "GET", description = "Search an object by id, regardless of its status")
    @ApiResponses(value = {
    ...
    /**
     * @param dto represents the Country object to be created
     */
    @Operation(summary = "Insert a new Country", method = "POST")
    @ApiResponses(value = {
    ...
    public ResponseEntity<?> create(
            @RequestBody
            @Schema(
                    description = "Country object for creation",
    ...
    /**
     * @param dto represents the Country object to be updated
     */
    @Operation(summary = "Update a Country", method = "PUT")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Ok"),
            @ApiResponse(responseCode = "400", description = "Bad Request"),
            @ApiResponse(responseCode = "401", description = "Unauthorized"),
    ...
    public ResponseEntity<?> update(
            @RequestBody
            @Schema(
                    description = "Country object for editing",
    ...
    /**
     * @param codes list of Country codes to be deleted
     */
    @Operation(summary = "Delete a list of Countries", method = "DELETE", description = "The status of the objects is changed to 'Trash'")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Ok"),
