package br.com.projects.webapi.api.v1.rest.countryattachment;
...
@Tag(name = "CountryAttachment")
@RestController
@RequestMapping("/api/countryattachment")
public class CountryAttachmentController {

    private final CountryAttachmentService service;

    public CountryAttachmentController(CountryAttachmentService service) {
     ...
     */
    @Operation(summary = "Search all CountryAttachments by columns, operations, and values", method = "GET")
    @ApiResponses(value = {
    ...
    /**
     * @param id represents the ID of the CountryAttachment to be searched
     */
    @Operation(summary = "Search a CountryAttachment by id", method = "GET", description = "Search an object by id, regardless of its status")
    @ApiResponses(value = {
    ...
    /**
     * @param dto represents the CountryAttachment object to be created
     */
    @Operation(summary = "Insert a new CountryAttachment", method = "POST")
    @ApiResponses(value = {
    ...
    public ResponseEntity<?> create(
            @RequestBody
            @Schema(
                    description = "CountryAttachment object for creation",
                    requiredProperties = "country.id, attachment.id",
                    example = """
                    {
                        "country": {
                            "id": 1
            ...
            DCountryAttachment dto) {
        return ResponseEntity.status(HttpStatus.CREATED).body(service.insert(dto));
    }

    /**
     * @param dto represents the CountryAttachment object to be updated
     */
    @Operation(summary = "Update a CountryAttachment", method = "PUT")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Ok"),
            @ApiResponse(responseCode = "400", description = "Bad Request"),
            @ApiResponse(responseCode = "401", description = "Unauthorized"),
    ...
    public ResponseEntity<?> update(
            @RequestBody
            @Schema(
                    description = "CountryAttachment object for editing",
                    requiredProperties = "id, country.id, attachment.id",
                    example = """
                    {
                        "id": 1,
                        "country": {
    ...
    /**
     * @param codes list of CountryAttachment codes to be deleted
     */
    @Operation(summary = "Delete a list of CountryAttachments", method = "DELETE", description = "The status of the objects is changed to 'Trash'")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Ok"),
