package br.com.projects.webapi.api.v1.rest.league;
...
public class LeagueController {
     ...
     */
    @Operation(summary = "Search all Leagues by columns, operations, and values", method = "GET")
    @ApiResponses(value = {
    ...
    /**
     * @param id represents the ID of the League to be searched
     */
    @Operation(summary = "Search a League by id", method = "GET", description = "Search an object by id, regardless of its status")
    @ApiResponses(value = {
    ...
    /**
     * @param dto represents the League object to be created
     */
    @Operation(summary = "Insert a new League", method = "POST")
    @ApiResponses(value = {
    ...
    public ResponseEntity<?> create(
            @RequestBody
            @Schema(
                    description = "League object for creation",
                    requiredProperties = "name, coutry.id",
                    example = """
                    {
    ...
    /**
     * @param dto represents the League object to be updated
     */
    @Operation(summary = "Update a League", method = "PUT")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Ok"),
            @ApiResponse(responseCode = "400", description = "Bad Request"),
            @ApiResponse(responseCode = "401", description = "Unauthorized"),
    ...
    public ResponseEntity<?> update(
            @RequestBody
            @Schema(
                    description = "League object for editing",
                    requiredProperties = "id, name, coutry.id",
                    example = """
                    {
                        "id": 1,
                        "league": "Premier League",
    ...
    /**
     * @param codes list of League codes to be deleted
     */
    @Operation(summary = "Delete a list of Leagues", method = "DELETE", description = "The status of the objects is changed to 'Trash'")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Ok"),
