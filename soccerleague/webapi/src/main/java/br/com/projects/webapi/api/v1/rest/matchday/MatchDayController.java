package br.com.projects.webapi.api.v1.rest.matchday;
...
public class MatchDayController {
     ...
     */
    @Operation(summary = "Search all MatchDays by columns, operations, and values", method = "GET")
    @ApiResponses(value = {
    ...
    /**
     * @param id represents the ID of the MatchDay to be searched
     */
    @Operation(summary = "Search a MatchDay by id", method = "GET", description = "Search an object by id, regardless of its status")
    @ApiResponses(value = {
    ...
    /**
     * @param dto represents the MatchDay object to be created
     */
    @Operation(summary = "Insert a new MatchDay", method = "POST")
    @ApiResponses(value = {
    ...
    public ResponseEntity<?> create(
            @RequestBody
            @Schema(
                    description = "MatchDay object for creation",
                    requiredProperties = "championship.id, number",
                    example = """
                    {
                        "championship": {
                            "id": 1
    ...
    /**
     * @param dto represents the MatchDay object to be updated
     */
    @Operation(summary = "Update a MatchDay", method = "PUT")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Ok"),
            @ApiResponse(responseCode = "400", description = "Bad Request"),
            @ApiResponse(responseCode = "401", description = "Unauthorized"),
    ...
    public ResponseEntity<?> update(
            @RequestBody
            @Schema(
                    description = "MatchDay object for editing",
                    requiredProperties = "id, championship.id, number",
                    example = """
                    {
                        "id": 1,
                        "championship": {
    ...
    /**
     * @param codes list of MatchDay codes to be deleted
     */
    @Operation(summary = "Delete a list of MatchDays", method = "DELETE", description = "The status of the objects is changed to 'Trash'")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Ok"),
