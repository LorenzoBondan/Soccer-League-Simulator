package br.com.projects.webapi.api.v1.rest.matchevent;
...
public class MatchEventController {
     ...
     */
    @Operation(summary = "Search all MatchEvents by columns, operations, and values", method = "GET")
    @ApiResponses(value = {
        ...
        return ResponseEntity.ok(
                service.find(PageableRequest.builder()
                        ...
                        .columnMap(Map.of(
                                ...
                                "minuteMatchEvent", "minuteMatchEvent"))
                        .build())
        );
    }

    /**
     * @param id represents the ID of the MatchEvent to be searched
     */
    @Operation(summary = "Search a MatchEvent by id", method = "GET", description = "Search an object by id, regardless of its status")
    @ApiResponses(value = {
    ...
    /**
     * @param dto represents the MatchEvent object to be created
     */
    @Operation(summary = "Insert a new MatchEvent", method = "POST")
    @ApiResponses(value = {
    ...
    public ResponseEntity<?> create(
            @RequestBody
            @Schema(
                    description = "MatchEvent object for creation",
                    requiredProperties = "match.id, type, player1.id, minuteMatchEvent",
                    example = """
                    {
                        "match": {
                            "id": 1
    ...
    /**
     * @param dto represents the MatchEvent object to be updated
     */
    @Operation(summary = "Update a MatchEvent", method = "PUT")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Ok"),
            @ApiResponse(responseCode = "400", description = "Bad Request"),
            @ApiResponse(responseCode = "401", description = "Unauthorized"),
    ...
    public ResponseEntity<?> update(
            @RequestBody
            @Schema(
                    description = "MatchEvent object for editing",
                    requiredProperties = "id, match.id, type, player1.id, minuteMatchEvent",
                    example = """
                    {
                        "id": 1,
                        "match": {
    ...
    /**
     * @param codes list of MatchEvent codes to be deleted
     */
    @Operation(summary = "Delete a list of MatchEvents", method = "DELETE", description = "The status of the objects is changed to 'Trash'")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Ok"),
