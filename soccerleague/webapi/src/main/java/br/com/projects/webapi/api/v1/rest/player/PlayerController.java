package br.com.projects.webapi.api.v1.rest.player;
...
public class PlayerController {
     ...
     */
    @Operation(summary = "Search all Players by columns, operations, and values", method = "GET")
    @ApiResponses(value = {
    ...
    /**
     * @param id represents the ID of the Player to be searched
     */
    @Operation(summary = "Search a Player by id", method = "GET", description = "Search an object by id, regardless of its status")
    @ApiResponses(value = {
    ...
    /**
     * @param dto represents the Player object to be created
     */
    @Operation(summary = "Insert a new Player", method = "POST")
    @ApiResponses(value = {
    ...
    public ResponseEntity<?> create(
            @RequestBody
            @Schema(
                    description = "Player object for creation",
                    requiredProperties = "name, nickname, birthDate, position, team.id",
                    example = """
                    {
                        "name": "Player",
                        "nickname": "Player",
                        "birthDate": "2020-10-10T10:10:10",
                        "position": "MIDDLE_FIELD",
                        "team": {
                            "id": 1
                        }
                    }
    ...
    /**
     * @param dto represents the Player object to be updated
     */
    @Operation(summary = "Update a Player", method = "PUT")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Ok"),
            @ApiResponse(responseCode = "400", description = "Bad Request"),
            @ApiResponse(responseCode = "401", description = "Unauthorized"),
    ...
    public ResponseEntity<?> update(
            @RequestBody
            @Schema(
                    description = "Player object for editing",
                    requiredProperties = "id, name, nickname, birthDate, position, team.id",
                    example = """
                    {
                        "id": 1,
                        "name": "Player",
    ...
    /**
     * @param codes list of Player codes to be deleted
     */
    @Operation(summary = "Delete a list of Players", method = "DELETE", description = "The status of the objects is changed to 'Trash'")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Ok"),
