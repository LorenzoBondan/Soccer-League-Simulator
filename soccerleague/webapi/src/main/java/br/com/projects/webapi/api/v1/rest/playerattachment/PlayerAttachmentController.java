package br.com.projects.webapi.api.v1.rest.playerattachment;
...
@Tag(name = "PlayerAttachment")
@RestController
@RequestMapping("/api/playerattachment")
public class PlayerAttachmentController {

    private final PlayerAttachmentService service;

    public PlayerAttachmentController(PlayerAttachmentService service) {
     ...
     */
    @Operation(summary = "Search all PlayerAttachments by columns, operations, and values", method = "GET")
    @ApiResponses(value = {
    ...
    /**
     * @param id represents the ID of the PlayerAttachment to be searched
     */
    @Operation(summary = "Search a PlayerAttachment by id", method = "GET", description = "Search an object by id, regardless of its status")
    @ApiResponses(value = {
    ...
    /**
     * @param dto represents the PlayerAttachment object to be created
     */
    @Operation(summary = "Insert a new PlayerAttachment", method = "POST")
    @ApiResponses(value = {
    ...
    public ResponseEntity<?> create(
            @RequestBody
            @Schema(
                    description = "PlayerAttachment object for creation",
                    requiredProperties = "player.id, attachment.id",
                    example = """
                    {
                        "player": {
                            "id": 1
            ...
            DPlayerAttachment dto) {
        return ResponseEntity.status(HttpStatus.CREATED).body(service.insert(dto));
    }

    /**
     * @param dto represents the PlayerAttachment object to be updated
     */
    @Operation(summary = "Update a PlayerAttachment", method = "PUT")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Ok"),
            @ApiResponse(responseCode = "400", description = "Bad Request"),
            @ApiResponse(responseCode = "401", description = "Unauthorized"),
    ...
    public ResponseEntity<?> update(
            @RequestBody
            @Schema(
                    description = "PlayerAttachment object for editing",
                    requiredProperties = "id, player.id, attachment.id",
                    example = """
                    {
                        "id": 1,
                        "player": {
    ...
    /**
     * @param codes list of PlayerAttachment codes to be deleted
     */
    @Operation(summary = "Delete a list of PlayerAttachments", method = "DELETE", description = "The status of the objects is changed to 'Trash'")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Ok"),
