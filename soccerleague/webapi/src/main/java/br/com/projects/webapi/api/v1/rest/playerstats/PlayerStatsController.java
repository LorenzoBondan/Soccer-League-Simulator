package br.com.projects.webapi.api.v1.rest.playerstats;
...
public class PlayerStatsController {
     ...
     */
    @Operation(summary = "Search all PlayerStats by columns, operations, and values", method = "GET")
    @ApiResponses(value = {
    ...
    /**
     * @param id represents the ID of the PlayerStats to be searched
     */
    @Operation(summary = "Search a PlayerStats by id", method = "GET", description = "Search an object by id, regardless of its status")
    @ApiResponses(value = {
    ...
    /**
     * @param dto represents the PlayerStats object to be updated
     */
    @Operation(summary = "Update a PlayerStats", method = "PUT")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Ok"),
            @ApiResponse(responseCode = "400", description = "Bad Request"),
            @ApiResponse(responseCode = "401", description = "Unauthorized"),
    ...
    /**
     * @param codes list of PlayerStats codes to be deleted
     */
    @Operation(summary = "Delete a list of PlayerStats", method = "DELETE", description = "The status of the objects is changed to 'Trash'")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Ok"),
