package br.com.projects.webapi.api.v1.rest.position;
...
public class PositionController {
     ...
     */
    @Operation(summary = "Search all Positions by columns, operations, and values", method = "GET")
    @ApiResponses(value = {
    ...
    /**
     * @param id represents the ID of the Position to be searched
     */
    @Operation(summary = "Search a Position by id", method = "GET", description = "Search an object by id, regardless of its status")
    @ApiResponses(value = {
