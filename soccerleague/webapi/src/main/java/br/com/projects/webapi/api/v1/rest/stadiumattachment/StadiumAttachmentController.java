package br.com.projects.webapi.api.v1.rest.stadiumattachment;
...
@Tag(name = "StadiumAttachment")
@RestController
@RequestMapping("/api/stadiumattachment")
public class StadiumAttachmentController {

    private final StadiumAttachmentService service;

    public StadiumAttachmentController(StadiumAttachmentService service) {
     ...
     */
    @Operation(summary = "Search all StadiumAttachments by columns, operations, and values", method = "GET")
    @ApiResponses(value = {
    ...
    /**
     * @param id represents the ID of the StadiumAttachment to be searched
     */
    @Operation(summary = "Search a StadiumAttachment by id", method = "GET", description = "Search an object by id, regardless of its status")
    @ApiResponses(value = {
    ...
    /**
     * @param dto represents the StadiumAttachment object to be created
     */
    @Operation(summary = "Insert a new StadiumAttachment", method = "POST")
    @ApiResponses(value = {
    ...
    public ResponseEntity<?> create(
            @RequestBody
            @Schema(
                    description = "StadiumAttachment object for creation",
                    requiredProperties = "stadium.id, attachment.id",
                    example = """
                    {
                        "stadium": {
                            "id": 1
            ...
            DStadiumAttachment dto) {
        return ResponseEntity.status(HttpStatus.CREATED).body(service.insert(dto));
    }

    /**
     * @param dto represents the StadiumAttachment object to be updated
     */
    @Operation(summary = "Update a StadiumAttachment", method = "PUT")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Ok"),
            @ApiResponse(responseCode = "400", description = "Bad Request"),
            @ApiResponse(responseCode = "401", description = "Unauthorized"),
    ...
    public ResponseEntity<?> update(
            @RequestBody
            @Schema(
                    description = "StadiumAttachment object for editing",
                    requiredProperties = "id, stadium.id, attachment.id",
                    example = """
                    {
                        "id": 1,
                        "stadium": {
    ...
    /**
     * @param codes list of StadiumAttachment codes to be deleted
     */
    @Operation(summary = "Delete a list of StadiumAttachments", method = "DELETE", description = "The status of the objects is changed to 'Trash'")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Ok"),
