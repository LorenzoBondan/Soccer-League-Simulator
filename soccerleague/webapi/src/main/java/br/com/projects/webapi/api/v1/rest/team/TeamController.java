package br.com.projects.webapi.api.v1.rest.team;
...
public class TeamController {
     ...
     */
    @Operation(summary = "Search all Teams by columns, operations, and values", method = "GET")
    @ApiResponses(value = {
    ...
    /**
     * @param id represents the ID of the Team to be searched
     */
    @Operation(summary = "Search a Team by id", method = "GET", description = "Search an object by id, regardless of its status")
    @ApiResponses(value = {
    ...
    /**
     * @param dto represents the Team object to be created
     */
    @Operation(summary = "Insert a new Team", method = "POST")
    @ApiResponses(value = {
    ...
    public ResponseEntity<?> create(
            @RequestBody
            @Schema(
                    description = "Team object for creation",
    ...
    /**
     * @param dto represents the Team object to be updated
     */
    @Operation(summary = "Update a Team", method = "PUT")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Ok"),
            @ApiResponse(responseCode = "400", description = "Bad Request"),
            @ApiResponse(responseCode = "401", description = "Unauthorized"),
    ...
    public ResponseEntity<?> update(
            @RequestBody
            @Schema(
                    description = "Team object for editing",
    ...
    /**
     * @param codes list of Team codes to be deleted
     */
    @Operation(summary = "Delete a list of Teams", method = "DELETE", description = "The status of the objects is changed to 'Trash'")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Ok"),
