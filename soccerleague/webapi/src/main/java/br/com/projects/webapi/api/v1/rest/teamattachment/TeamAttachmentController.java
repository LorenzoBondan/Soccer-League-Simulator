package br.com.projects.webapi.api.v1.rest.teamattachment;
...
@Tag(name = "TeamAttachment")
@RestController
@RequestMapping("/api/teamattachment")
public class TeamAttachmentController {

    private final TeamAttachmentService service;

    public TeamAttachmentController(TeamAttachmentService service) {
     ...
     */
    @Operation(summary = "Search all TeamAttachments by columns, operations, and values", method = "GET")
    @ApiResponses(value = {
    ...
    /**
     * @param id represents the ID of the TeamAttachment to be searched
     */
    @Operation(summary = "Search a TeamAttachment by id", method = "GET", description = "Search an object by id, regardless of its status")
    @ApiResponses(value = {
    ...
    /**
     * @param dto represents the TeamAttachment object to be created
     */
    @Operation(summary = "Insert a new TeamAttachment", method = "POST")
    @ApiResponses(value = {
    ...
    public ResponseEntity<?> create(
            @RequestBody
            @Schema(
                    description = "TeamAttachment object for creation",
                    requiredProperties = "team.id, attachment.id",
                    example = """
                    {
                        "team": {
                            "id": 1
    ...
    /**
     * @param dto represents the TeamAttachment object to be updated
     */
    @Operation(summary = "Update a TeamAttachment", method = "PUT")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Ok"),
            @ApiResponse(responseCode = "400", description = "Bad Request"),
            @ApiResponse(responseCode = "401", description = "Unauthorized"),
    ...
    public ResponseEntity<?> update(
            @RequestBody
            @Schema(
                    description = "TeamAttachment object for editing",
                    requiredProperties = "id, team.id, attachment.id",
                    example = """
                    {
                        "id": 1,
                        "team": {
    ...
    /**
     * @param codes list of TeamAttachment codes to be deleted
     */
    @Operation(summary = "Delete a list of TeamAttachments", method = "DELETE", description = "The status of the objects is changed to 'Trash'")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Ok"),
