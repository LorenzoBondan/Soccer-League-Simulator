package br.com.projects.webapi.api.v1.rest.trophy;
...
public class TrophyController {
    ...
    public TrophyController(TrophyService service) {
    ...
    /**
     * @param id represents the ID of the Trophy to be searched
     */
    @Operation(summary = "Search a Trophy by id", method = "GET", description = "Search an object by id, regardless of its status")
    @ApiResponses(value = {
    ...
    /**
     * @param dto represents the Trophy object to be created
     */
    @Operation(summary = "Insert a new Trophy", method = "POST")
    @ApiResponses(value = {
    ...
    public ResponseEntity<?> create(
            @RequestBody
            @Schema(
                    description = "Trophy object for creation",
    ...
    /**
     * @param dto represents the Trophy object to be updated
     */
    @Operation(summary = "Update a Trophy", method = "PUT")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Ok"),
            @ApiResponse(responseCode = "400", description = "Bad Request"),
            @ApiResponse(responseCode = "401", description = "Unauthorized"),
    ...
    public ResponseEntity<?> update(
            @RequestBody
            @Schema(
                    description = "Trophy object for editing",
    ...
    /**
     * @param codes list of Trophy codes to be deleted
     */
    @Operation(summary = "Delete a list of Trophys", method = "DELETE", description = "The status of the objects is changed to 'Trash'")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Ok"),
