package br.com.projects.webapi.api.v1.rest.trophyattachment;
...
@Tag(name = "TrophyAttachment")
@RestController
@RequestMapping("/api/trophyattachment")
public class TrophyAttachmentController {

    private final TrophyAttachmentService service;

    public TrophyAttachmentController(TrophyAttachmentService service) {
     ...
     */
    @Operation(summary = "Search all TrophyAttachments by columns, operations, and values", method = "GET")
    @ApiResponses(value = {
    ...
    /**
     * @param id represents the ID of the TrophyAttachment to be searched
     */
    @Operation(summary = "Search a TrophyAttachment by id", method = "GET", description = "Search an object by id, regardless of its status")
    @ApiResponses(value = {
    ...
    /**
     * @param dto represents the TrophyAttachment object to be created
     */
    @Operation(summary = "Insert a new TrophyAttachment", method = "POST")
    @ApiResponses(value = {
    ...
    public ResponseEntity<?> create(
            @RequestBody
            @Schema(
                    description = "TrophyAttachment object for creation",
                    requiredProperties = "trophy.id, attachment.id",
                    example = """
                    {
                        "trophy": {
                            "id": 1
            ...
            DTrophyAttachment dto) {
        return ResponseEntity.status(HttpStatus.CREATED).body(service.insert(dto));
    }

    /**
     * @param dto represents the TrophyAttachment object to be updated
     */
    @Operation(summary = "Update a TrophyAttachment", method = "PUT")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Ok"),
            @ApiResponse(responseCode = "400", description = "Bad Request"),
            @ApiResponse(responseCode = "401", description = "Unauthorized"),
    ...
    public ResponseEntity<?> update(
            @RequestBody
            @Schema(
                    description = "TrophyAttachment object for editing",
                    requiredProperties = "id, trophy.id, attachment.id",
                    example = """
                    {
                        "id": 1,
                        "trophy": {
    ...
    /**
     * @param codes list of TrophyAttachment codes to be deleted
     */
    @Operation(summary = "Delete a list of TrophyAttachments", method = "DELETE", description = "The status of the objects is changed to 'Trash'")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Ok"),
