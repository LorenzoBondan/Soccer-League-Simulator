package br.com.projects.webapi.api.v1.rest.trophyteam;
...
@Tag(name = "TrophyTeam")
@RestController
@RequestMapping("/api/trophyteam")
public class TrophyTeamController {

    private final TrophyTeamService service;

    public TrophyTeamController(TrophyTeamService service) {
     ...
     */
    @Operation(summary = "Search all TrophyTeams by columns, operations, and values", method = "GET")
    @ApiResponses(value = {
    ...
    /**
     * @param id represents the ID of the TrophyTeam to be searched
     */
    @Operation(summary = "Search a TrophyTeam by id", method = "GET", description = "Search an object by id, regardless of its status")
    @ApiResponses(value = {
    ...
    /**
     * @param dto represents the TrophyTeam object to be created
     */
    @Operation(summary = "Insert a new TrophyTeam", method = "POST")
    @ApiResponses(value = {
    ...
    public ResponseEntity<?> create(
            @RequestBody
            @Schema(
                    description = "TrophyTeam object for creation",
                    requiredProperties = "trophy.id, team.id, quantity",
                    example = """
                    {
                        "trophy": {
                            "id": 1
    ...
    /**
     * @param dto represents the TrophyTeam object to be updated
     */
    @Operation(summary = "Update a TrophyTeam", method = "PUT")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Ok"),
            @ApiResponse(responseCode = "400", description = "Bad Request"),
            @ApiResponse(responseCode = "401", description = "Unauthorized"),
    ...
    public ResponseEntity<?> update(
            @RequestBody
            @Schema(
                    description = "TrophyTeam object for editing",
                    requiredProperties = "id, trophy.id, team.id, quantity",
                    example = """
                    {
                        "id": 1,
                        "trophy": {
    ...
    /**
     * @param codes list of TrophyTeam codes to be deleted
     */
    @Operation(summary = "Delete a list of TrophyTeams", method = "DELETE", description = "The status of the objects is changed to 'Trash'")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Ok"),
